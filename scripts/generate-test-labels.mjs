// Generates a bulk-import test fixture: synthetic label images plus the
...
Import \`applications.csv\` into the **Application data** dropzone and everything in \`images/\` into the **Label photos** dropzone.
